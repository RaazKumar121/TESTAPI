...
const LotteryOfferSchema = new mongoose_1.Schema({
    exclude_lottery: {
...
const LotteryOffer = mongoose_1.default.models.lottery_offers ||
    mongoose_1.default.model("lottery_offers", LotteryOfferSchema);
exports.default = LotteryOffer;
